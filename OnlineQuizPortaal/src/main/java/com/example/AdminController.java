...
public class AdminController {
	...
	///create new record
	@PostMapping("/quiz")
	public ResponseEntity<QuizCompetition> addUserr(@RequestBody QuizCompetition u){
		QuizCompetition user= quizService.addUser(u);
		if(user!=null)  
	...
	//List of Users Or RETRIVE DATA
	@GetMapping("/quiz")
	public  List<QuizCompetition> getAllUserr(){
		return quizService.getAllUser();
	}
}
